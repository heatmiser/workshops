...
-   Click ![launch](images/3-convert2rhel-aap2-launch.png) to the right of **CONVERT2RHEL / 96 - Three Tier App deployment** to launch the job.  This will take ~2 minutes to complete.
...
-   Click ![copy template](images/3-convert2rhel-copy-template-icon.png) to the right of **CONVERT2RHEL / 01 - Take node snapshot** to copy the template.
...
- Click ![launch](images/3-convert2rhel-aap2-launch.png) to the right of **CONVERT2RHEL / 97 - Three Tier App smoke test** to launch the job.
...
- Click ![launch](images/3-convert2rhel-aap2-launch.png) to the right of **CONVERT2RHEL / 02 - Upgrade OS to latest release** to launch the job.
...
-   Click ![launch](images/3-convert2rhel-aap2-launch.png) to the right of **CONVERT2RHEL / 03 - convert2rhel** to launch the job.
...
![conversion-confirm](images/3-convert2rhel-conversion-confirm.png)
...
-   Click ![launch](images/3-convert2rhel-aap2-launch.png) to the right of **EC2 / Set instance tags based on Satellite(Foreman) facts** to launch the job.
...
-   Click ![launch](images/3-convert2rhel-aap2-launch.png) to the right of **CONTROLLER / Update inventories via dynamic sources** to launch the job.
...
-   Click ![copy template](images/3-convert2rhel-copy-template-icon.png) to the right of **Workshop Credential** to copy the credential.
...
![converted-RHEL-credential](images/3-convert2rhel-workshop-credential.png)
...
-   Click ![copy template](images/3-convert2rhel-copy-template-icon.png) to the right of **CONVERT2RHEL / 97 - Three Tier App smoke test** to copy the template.
...
-   Click **Edit** at the bottom left.
    ...
    - Click ![lookup](images/3-convert2rhel-lookup-icon.png) under Inventory and select the radio button for **RHEL7 Development**, followed by **Select**.
    - Click ![lookup](images/3-convert2rhel-lookup-icon.png) under Credentials and select the radio button for **Converted RHEL Credential**, followed by **Select**.
